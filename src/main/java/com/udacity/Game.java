...
//      check horizontally
        ...
        else if ((grid[0][1] == grid[1][1]) && (grid[1][1] == grid[2][1]) && grid[0][1] != '-') {winner = grid[0][1];}
        else if ((grid[0][2] == grid[1][2]) && (grid[1][2] == grid[2][2]) && grid[0][2] != '-') {winner = grid[0][2];}

//      check vertically
        else if ((grid[0][0] == grid[0][1]) && (grid[0][1] == grid[0][2]) && grid[0][0] != '-') {winner = grid[0][0];}
        else if ((grid[1][0] == grid[1][1]) && (grid[1][1] == grid[1][2]) && grid[1][0] != '-') {winner = grid[1][0];}
        else if  ((grid[2][0] == grid[2][1]) && (grid[2][1] == grid[2][2]) && grid[2][0] != '-') {winner = grid[2][0];}

//      check diagonally
        else if  ((grid[0][0] == grid[1][1]) && (grid[1][1] == grid[2][2]) && grid[0][0] != '-') {winner = grid[0][0];}
        else if  ((grid[0][2] == grid[1][1]) && (grid[1][1] == grid[2][0]) && grid[0][2] != '-') {winner = grid[0][2];}
